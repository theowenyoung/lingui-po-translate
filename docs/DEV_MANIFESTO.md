...
The development of `lingui-ai-translate` is guided by the principles that are described in this document.

## Focus on "Time-to-Value"

`lingui-ai-translate` is a semi-automated tool.
...
`lingui-ai-translate` is a generic tool that should not enforce any specific workflows. 
For example, `lingui-ai-translate` should not enforce any specific directory structure.
